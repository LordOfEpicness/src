...
public class FUCBlockGrass1 extends Block
{
...
public FUCBlockGrass1(int par1)
{
...
{
par1World.setBlock(i1, j1, k1, MainBlock.blockFUCGrass_1.blockID);
}
}
}
}
...
{
this.blockIcon = par1IconRegister.registerIcon("monsterhunter:fucGrassSide");
this.iconGrassTop = par1IconRegister.registerIcon("monsterhunter:fucGrassTop");
this.iconGrassBottom = par1IconRegister.registerIcon("monsterhunter:fucDirt");
this.iconGrassSideOverlay = par1IconRegister.registerIcon("monsterhunter:fucDirt");
}
