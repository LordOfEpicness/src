...
public class EntityBlazeTest extends EntityMob implements IMob
{
    ...
    public int lightningcounter = 35;

    /** The explosion radius of spawned fireballs. */
    private int explosionStrength = 2;

    public EntityBlazeTest(World par1World)
    {
        super(par1World);
    ...
    public boolean attackEntityFrom(DamageSource par1DamageSource, int par2)
    {
        ...
        else if ("lightningbolt".equals(par1DamageSource.getDamageType()) && par1DamageSource.getEntity() instanceof EntityPlayer)
        {
    ...
    protected void updateEntityActionState()
    {
        ...
        this.despawnEntity();
        this.prevAttackCounter = this.lightningcounter;
        ...
        if (this.targetedEntity != null && this.targetedEntity.getDistanceSqToEntity(this) < d4 * d4)
        {
            ...
            if (this.canEntityBeSeen(this.targetedEntity))
            {
                ...
                if (this.lightningcounter == 20)
                {
                    this.worldObj.playAuxSFXAtEntity((EntityPlayer)null, 1008, (int)this.posX, (int)this.posY, (int)this.posZ, 0);
                    EntityLightningBolt entitylightningbolt = new EntityLightningBolt(this.worldObj, d5, d6, d7);
                    entitylightningbolt.boltVertex = this.explosionStrength;
                    double d8 = 4.0D;
                    Vec3 vec3 = this.getLook(1.0F);
                    entitylightningbolt.posX = this.posX + vec3.xCoord * d8;
                    entitylightningbolt.posY = this.posY + (double)(this.height / 2.0F) + 0.5D;
                    entitylightningbolt.posZ = this.posZ + vec3.zCoord * d8;
                    this.worldObj.spawnEntityInWorld(entitylightningbolt);
                    this.lightningcounter = -40;
                }
            }
            else if (this.lightningcounter > 0)
            {
                --this.lightningcounter;
            }
        }
        ...
        {
            byte b0 = this.dataWatcher.getWatchableObjectByte(16);
            byte b1 = (byte)(this.lightningcounter > 10 ? 1 : 0);
