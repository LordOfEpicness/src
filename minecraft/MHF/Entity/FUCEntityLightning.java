...
public class FUCEntityLightning extends EntityThrowable
{
	public EntityLiving el;
	public long field_92057_e;

    public FUCEntityLightning(World world)
    {
        super(world);
    }

    public FUCEntityLightning(World world, EntityLiving entityliving)
    {
        super(world, entityliving);
    }

    public FUCEntityLightning(World world, double d, double d1, double d2)
    {
        super(world, d, d1, d2);
    }
    ...
    {
    	worldObj.spawnParticle("reddust", this.posX, this.posY, this.posZ, 0.0D, 0.0D, 0.0D);
