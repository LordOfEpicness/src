...
public class ItemWyverniaPortalStaff extends Item
{
public ItemWyverniaPortalStaff(int par1)
{
super(par1);
...
par3World.setBlock(X, Y + 2, Z, MainBlock.blockDesign.blockID);
par3World.setBlock(X + 1, Y + 2, Z, MainBlock.blockDesign.blockID);
...
par3World.setBlock(X + 2, Y + 3, Z, MainBlock.blockDesign.blockID);
par3World.setBlock(X - 1, Y + 3, Z, MainBlock.blockDesign.blockID);
par3World.setBlock(X + 3, Y + 4, Z, Block.oreDiamond.blockID);
par3World.setBlock(X - 2, Y + 4, Z, Block.oreDiamond.blockID);
par3World.setBlock(X + 2, Y + 4, Z, MainBlock.blockDesign.blockID);
par3World.setBlock(X - 1, Y + 4, Z, MainBlock.blockDesign.blockID);
par3World.setBlock(X + 3, Y + 5, Z, Block.oreDiamond.blockID);
par3World.setBlock(X - 2, Y + 5, Z, Block.oreDiamond.blockID);
par3World.setBlock(X + 2, Y + 5, Z, MainBlock.blockDesign.blockID);
par3World.setBlock(X - 1, Y + 5, Z, MainBlock.blockDesign.blockID);
...
par3World.setBlock(X, Y + 6, Z, MainBlock.blockDesign.blockID);
par3World.setBlock(X + 1, Y + 6, Z, MainBlock.blockDesign.blockID);
par3World.setBlock(X, Y + 3, Z, MainBlock.Portal.blockID);
}
else
{
for (int y = 1; y < 5; y++)
...
{
        itemIcon = iconRegister.registerIcon("monsterhunter:wyerniaStaff");
}
