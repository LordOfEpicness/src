...
public class RenderFUCItemAgitoGreatSword implements IItemRenderer 
{
	static final Minecraft mc= Minecraft.getMinecraft();
	// Declarations

	protected ModelItemFUCAgitoGreatSword Hammer;
	public RenderFUCItemAgitoGreatSword()
	{
		Hammer = new ModelItemFUCAgitoGreatSword();
	...
	public void renderItem(ItemRenderType ItemRenderType, ItemStack ItemStack, Object... Data) 
	{
		switch(ItemRenderType)
		{
			case EQUIPPED: 
			{
				Minecraft.getMinecraft().renderEngine.bindTexture("/mods/monsterhunter/textures/items/FUCItemRender/boneGreatSword.png");
