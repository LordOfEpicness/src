...
public class RenderFUCLightningBolt extends Render
{
    /**
     * Actually renders the lightning bolt. This method is called through the doRender method.
     */
    public void doRenderLightningBolt(FUCEntityKirinThunder par1EntityLightningBolt, double par2, double par4, double par6, float par8, float par9)
    {
    ...
    {
        this.doRenderLightningBolt((FUCEntityKirinThunder)par1Entity, par2, par4, par6, par8, par9);
    }
}
