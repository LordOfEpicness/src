...
import MHF.World.gen.layer.GenLayerWyvernia;
...
public class WorldChunkManagerWyvernia extends WorldChunkManager
{
...
protected WorldChunkManagerWyvernia()
{
this.myBiomeCache = new BiomeCache(this);
this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
this.myBiomesToSpawnIn.add(BiomeManagerWyvernia.WyverniaHighlands);
this.myBiomesToSpawnIn.add(BiomeManagerWyvernia.WyverniaSnowyMountains);
this.myBiomesToSpawnIn.add(BiomeManagerWyvernia.WyverniaDesert);

}

public WorldChunkManagerWyvernia(long seed, WorldType worldtype)
{
this();
// i changed this to my GenLayerTutorial
GenLayer[] agenlayer = GenLayerWyvernia.makeTheWorld(seed);
this.myGenBiomes = agenlayer[0];
this.myBiomeIndexLayer = agenlayer[1];
}

public WorldChunkManagerWyvernia(World world)
{
...
if (biome == null)
{
return BiomeManagerWyvernia.WyverniaHighlands;
}
...
par1ArrayOfBiomeGenBase[i] = BiomeManagerWyvernia.WyverniaHighlands;
}
}
