...
public class WorldGenWyverniaTree1 extends WorldGenerator
{
    ...
    public WorldGenWyverniaTree1(boolean par1)
    {
        this(par1, 4, 0, 0, false);
    }

    public WorldGenWyverniaTree1(boolean par1, int par2, int par3, int par4, boolean par5)
    {
        super(par1);
                        ...
                        if (i1 >= 0 && i1 < 256)
                        {
                            ...
                            if (k1 != 0 &&
                               !block.isLeaves(par1World, l1, i1, j1) &&
                                k1 != MainBlock.blockFUCGrass_1.blockID &&
                                k1 != MainBlock.blockFUCDirt_1.blockID &&
